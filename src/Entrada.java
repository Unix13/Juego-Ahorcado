...
public class Entrada {
	...
	/**
	 * Método que permite la lectura desde teclado de un número entero entre un
	 * valor máximo y uno mínimo
	 * 
	...
	public static int leerEntero(int minimo, int maximo) {
		...
		do {
			...
			if (numero < minimo || numero > maximo)
				System.out.format("Error. El número tiene que estar entre 0 y 2 (ambos incluidos).\n"
	...
	/**
	 * Método que permite la lectura desde teclado de un número entero largo o
	 * long
	 * 
	 * @return devuelve el número introducido desde teclado
	 */
	...
	/**
	 * Método que permite la lectura desde teclado de un número decimal de mayor
	 * precisión
	 * 
	 * @return devuelve el número introducido desde teclado
	 */
