...
public class Ahorcado {
    ...
    private static String[][] palabras = {
        ...
        {"CUADRATURA",
            "Situación relativa de dos cuerpos celestes, que en longitud o en ascensión recta distan entre sí respectivamente uno o tres cuartos de círculo."},
        {"DALTONISMO",
            "Defecto de la vista que consiste en no percibir determinados colores o en confundir algunos de los que se perciben."},
        {"EQUILIBRAR",
            "Compensar las masas de un mecanismo con el fin de evitar vibraciones perjudiciales en su funcionamiento."},
        {"FIABILIDAD", "Probabilidad de buen funcionamiento de algo."},
        {"GIGANTILLO", "Figura de enano de gran cabeza."}, {"HABICHUELA", "Diminutivo de haba. Judía."},
        {"ICONOLOGIA", "Estudio de las imágenes y de su valor simbólico."},
        {"JUBILACION", "Pensión que recibe quien se ha jubilado."}};

    /**
     * Array de caracteres que almacena las letras correctas que introduce el
     * usuario.
     */
    ...
    /**
     * Método en el que se desarrolla el juego hasta que el usuario gana o
     * pierde.
     */
    ...
    /**
     * Comprueba si la letra pasada por parámetro se encuentra en la palabra
     * buscada y va añadiendolas al array de la respuesta. Si ya se ha dicho la
     * letra lo tomará como un fallo.
     *
